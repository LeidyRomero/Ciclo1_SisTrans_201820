...
CREATE sequence superandes_sequence;
 ...
 CREATE
  ...
  (
    ...
    IDFACTURA NUMBER,
    CONSTRAINT A_HISTORIAL_COMPRAS_PK PRIMARY KEY(CORREOCLIENTE, IDFACTURA)
  );
...
-- Creacion de la tabla BODEGA y especificacion de sus restricciones
 CREATE
  TABLE A_BODEGA
  (
      TIPOBODEGA VARCHAR(255)NOT NULL,
...
CREATE
 ...
 CREATE
    ...
    (
        ...
        CIUDAD VARCHAR(255),
        IDFACTURA NUMBER,
        CONSTRAINT A_FACTURAS_PK PRIMARY KEY(DIRECCIONSUCURSAL, CIUDAD, IDFACTURA)
    );
 ...
 CREATE
    ...
    (
        ...
        CONSTRAINT A_PRODUCTO_cATEGORIA_PK PRIMARY KEY(CODIGOBARRAS, CATEGORIA)
    );
